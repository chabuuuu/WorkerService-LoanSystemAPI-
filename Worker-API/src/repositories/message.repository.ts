...
export class MessageRepository implements IBaseRepository<MessageLog>{
    ...
    update(params: any): Promise<{ id: number; schedule_id: number; content: string; name_exchange: string; createdAt: Date; updatedAt: Date; jobScheduleId: number; }> {
        throw new Error("Method not implemented.");
    }
    delete(params: any): Promise<{ id: number; schedule_id: number; content: string; name_exchange: string; createdAt: Date; updatedAt: Date; jobScheduleId: number; }> {
        throw new Error("Method not implemented.");
    }
